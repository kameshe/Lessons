...
# Чтобы получить класс - нужно наследовать от object
class Human(object):
    # Атрибут класса. Он разделяется всеми экземплярами этого класса
    species = 'H. sapiens'

    # Обычный конструктор, вызывается при инициализации экземпляра класса
    # Обратите внимание, что двойное подчеркивание в начале и в конце имени
    # означает объекты и атрибуты, которые используются Python, но находятся
    # в пространствах имен, управляемых пользователем.
    # Не нужно придумывать им имена самостоятельно.
...
# Можно импортировать отдельные функции модуля
from math import ceil, floor
print(ceil(3.7)) # 4.0
print(floor(3.7)) # 3.0

# Можно импортировать все функции модуля.
from math import *
...
# Модули в Python - это обычные Python-файлы. Можно писать свои модули
# и импортировать их. Название модуля совпадает с названием файла.

# Можно узнать, какие функции и атрибуты определены в модуле
import math
dir(math)
...
# Генератор создает значения на лету. Он не возвращает все значения разом,
# а создает каждое из них при каждой итеации. Это значи, что значения больше
# 15 в double_numbers обработаны не будут.
# range - тоже генератор.
# Если нужно имя переменной, совпадающее с ключевым словом Python,
# используется подчеркивание в конце
...
# Декораторы. В этом примере beg оборачивает say.
